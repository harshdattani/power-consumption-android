		...
		findViewById(R.id.wrong1).setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
				...
				Thread mythread = new Thread() {
					...
					Intent q5 = new Intent(Question5.this, Total.class);
					q5.putExtra("total", total);
					startActivity(q5);
...
AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
		...
		alertDialogBuilder
		.setMessage("Tankless water heater saves more energy, as most energy is wasted keeping stored water heat.")
